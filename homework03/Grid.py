...
if __name__ == "__main__":
    ...
    lst1 = ["string", [1, 2, 3], [1, 2, 3, 4]]
    lst1 = [[1,2,3], "hello", [1, 2, 3, 4]]
    lst1 = [[None, None, None], [None, None, None], [None, None, None]]
    lst = None
    for i in range(len(lst1)):
        if not isinstance(lst1[i], list):
            raise ValueError
    print(len(lst1[0]) == 0)
    print(lst1[0][0] is None)
    # lst1 = [[1], [1,2,3], [2]]
    lst1 = [[], [], []]
    # lst1 = 4
    # lst1 = [[0, 2, 3], [1, 2, 3], [1, 2, 3]]
    # print(Grid.check_list_malformed(lst1))
